...
- Revenue performance
- Occupancy % trends
- ADR (Average Daily Rate) and RevPAR (Revenue Per Available Rooms)
- Realisation % and booking patterns
- Room category contributions
...
The top section of the dashboard highlights essential hospitality KPIs for **Atliq Grands**:
